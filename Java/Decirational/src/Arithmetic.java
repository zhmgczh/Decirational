...
public final class Arithmetic {
    ...
    public static boolean isPlus(final char c) {
        return '+' == c;
    }

    public static boolean isMinus(final char c) {
        return '-' == c;
    }

    public static boolean isFractionBar(final char c) {
        return '/' == c;
    }

    public static boolean isDecimalPoint(final char c) {
        return '.' == c;
    }

    public static boolean isCyclicBegin(final char c) {
        return cyclic_begin == c;
    }

    public static boolean isCyclicEnd(final char c) {
        return cyclic_end == c;
    }
    ...
    public static char toChar(final byte c) {
        return (char) (c + '0');
    }

    private static int getPrecedingZeros(final byte[] digits, final int digits_s, final int digits_length) {
    ...
    private static int getPrecedingZeros(final int[] integer, final int integer_s, final int integer_length) {
    ...
    public static byte[] optimize(final byte[] digits) {
        final int cut_length = Math.min(getPrecedingZeros(digits, 0, digits.length), digits.length - 1);
        byte[] result = digits;
        if (0 != cut_length) {
    ...
    public static int[] optimize(final int[] integer) {
        final int cut_length = Math.min(getPrecedingZeros(integer, 0, integer.length), integer.length - 1);
        int[] result = integer;
        if (0 != cut_length) {
    ...
    public static long reverseNegative(long number) {
        if (number < 0) {
            number = -number;
        }
        return number;
    ...
    private static byte passCarry(final byte[] digits, final byte sum, final int i) {
        final byte carry = (byte) (sum / 10);
        digits[i] = (byte) (0 == carry ? sum : (sum % 10));
        return carry;
    }

    private static int passCarry(final int[] integer, final long sum, final int i) {
    ...
    public static void add(final byte[] digits, final byte[] other_digits) {
        add(digits, 0, digits.length, other_digits, 0, other_digits.length);
    }
    ...
    public static void add(final int[] integer, final int[] other_integer) {
        add(integer, 0, integer.length, other_integer, 0, other_integer.length);
    }
    ...
    private static byte passBorrow(final byte[] digits, final byte difference, final int i) {
        final byte borrow = (byte) (difference >= 0 ? 0 : 1);
        digits[i] = (byte) (difference + (0 == borrow ? 0 : 10));
        return borrow;
    }

    private static int passBorrow(final int[] integer, final long difference, final int i) {
    ...
    public static void subtract(final byte[] digits, final byte[] other_digits) {
        subtract(digits, 0, digits.length, other_digits, 0, other_digits.length);
    }
    ...
    public static void subtract(final byte[] digits, final int digits_s, final int digits_length, final byte[] other_digits, final int other_digits_s, final int other_digits_length) {
        ...
        for (int i = digits_s + digits_length - 1; i >= diff; --i) {
            ...
            borrow = passBorrow(digits, sum, i);
            --other_index;
        }
        for (int i = diff - 1; i >= digits_s; --i) {
    ...
    public static void subtract(final int[] integer, final int[] other_integer) {
        subtract(integer, 0, integer.length, other_integer, 0, other_integer.length);
    }
    ...
    public static void subtract(final int[] integer, final int integer_s, final int integer_length, final int[] other_integer, final int other_integer_s, final int other_integer_length) {
        ...
        for (int i = integer_s + integer_length - 1; i >= diff; --i) {
            ...
            borrow = passBorrow(integer, difference, i);
            --other_index;
        }
        for (int i = diff - 1; i >= integer_s; --i) {
    ...
    public static void multiply(final byte[] digits, final byte[] a_digits, final byte[] b_digits) {
        multiply(digits, 0, digits.length, a_digits, 0, a_digits.length, b_digits, 0, b_digits.length);
    }
    ...
    public static void multiply(final byte[] digits, final int digits_s, final int digits_length, final byte[] a_digits, final int a_digits_s, final int a_digits_length, final byte[] b_digits, final int b_digits_s, final int b_digits_length) {
        for (int i = 1; i <= a_digits_length; ++i) {
            ...
            for (int b_digits_index = b_digits_s + b_digits_length - 1; b_digits_index >= b_digits_s; --b_digits_index) {
                ...
                carry = passCarry(digits, sum, digits_index);
                --digits_index;
            }
            if (carry != 0) {
    ...
    public static void multiply(final int[] integer, final int[] a_integer, final int[] b_integer) {
        multiply(integer, 0, integer.length, a_integer, 0, a_integer.length, b_integer, 0, b_integer.length);
    }
    ...
    public static void multiply(final int[] integer, final int integer_s, final int integer_length, final int[] a_integer, final int a_integer_s, final int a_integer_length, final int[] b_integer, final int b_integer_s, final int b_integer_length) {
        for (int i = 1; i <= a_integer_length; ++i) {
            ...
            for (int b_integer_index = b_integer_s + b_integer_length - 1; b_integer_index >= b_integer_s; --b_integer_index) {
                ...
                carry = passCarry(integer, sum, integer_index);
                --integer_index;
            }
            if (carry != 0) {
    ...
    public static void multiply(final byte[] digits, final byte a, final byte[] b_digits) {
        multiply(digits, 0, digits.length, a, b_digits, 0, b_digits.length);
    }
    ...
    public static void multiply(final int[] integer, final int a, final int[] b_integer) {
        multiply(integer, 0, integer.length, a, b_integer, 0, b_integer.length);
    }
    ...
    public static int compare(final byte[] a, final int a_s, final int a_length, final byte[] b, final int b_s, final int b_length) {
        final int new_a_s = getPrecedingZeros(a, a_s, a_length);
        final int new_b_s = getPrecedingZeros(b, b_s, b_length);
    ...
    private static int findRightBoundary(final byte[] dividend, final int dividend_s, final byte[] divisor, final int divisor_s, final int divisor_length) {
    ...
    private static int findRightBoundary(final int[] dividend, final int dividend_s, final int[] divisor, final int divisor_s, final int divisor_length) {
        final int divisor_e = divisor_s + divisor_length;
        final int dividend_bound = dividend_s + divisor_length - 1;
        int dividend_index = dividend_s;
        for (int i = divisor_s; i < divisor_e; ++i) {
    ...
    public static void divide(final byte[] quotient, final byte[] dividend, final byte[] divisor) {
        divide(quotient, 0, quotient.length, dividend, 0, dividend.length, divisor, 0, divisor.length);
    }
    ...
    public static void divide(final byte[] quotient, final int quotient_s, final int quotient_length, final byte[] dividend, final int dividend_s, final int dividend_length, final byte[] divisor, final int divisor_s, final int divisor_length) {
        final int new_divisor_s = getPrecedingZeros(divisor, divisor_s, divisor_length);
        ...
        int left_boundary = getPrecedingZeros(remaining_dividend, 0, remaining_dividend.length);
        int right_boundary = findRightBoundary(remaining_dividend, left_boundary, divisor, new_divisor_s, new_divisor_length);
        while (right_boundary < remaining_dividend.length) {
            ...
            left_boundary = getPrecedingZeros(remaining_dividend, left_boundary, remaining_dividend.length - left_boundary);
            right_boundary = findRightBoundary(remaining_dividend, left_boundary, divisor, new_divisor_s, new_divisor_length);
        }
    }
    ...
    public static void modulo(final byte[] remainder, final byte[] dividend, final byte[] divisor) {
        modulo(remainder, 0, remainder.length, dividend, 0, dividend.length, divisor, 0, divisor.length);
    }
    ...
    public static void modulo(final byte[] remainder, final int remainder_s, final int remainder_length, final byte[] dividend, final int dividend_s, final int dividend_length, final byte[] divisor, final int divisor_s, final int divisor_length) {
        ...
        final int starting_index = getPrecedingZeros(remaining_dividend, 0, remaining_dividend.length);
    ...
    public static void divideAndModulo(final byte[] quotient, final byte[] remainder, final byte[] dividend, final byte[] divisor) {
        divideAndModulo(quotient, 0, quotient.length, remainder, 0, remainder.length, dividend, 0, dividend.length, divisor, 0, divisor.length);
    }

    public static void divideAndModulo(final byte[] quotient, final int quotient_s, final int quotient_length, final byte[] remainder, final int remainder_s, final int remainder_length, final byte[] dividend, final int dividend_s, final int dividend_length, final byte[] divisor, final int divisor_s, final int divisor_length) {
        final int new_divisor_s = getPrecedingZeros(divisor, divisor_s, divisor_length);
        final int new_divisor_length = divisor_length - new_divisor_s + divisor_s;
        if (0 == new_divisor_length) {
            throw new ArithmeticException("divide by 0");
    ...
    public static void divideAndModulo(final int[] quotient, final int[] remainder, final int[] dividend, final int[] divisor) {
        divideAndModulo(quotient, 0, quotient.length, remainder, 0, remainder.length, dividend, 0, dividend.length, divisor, 0, divisor.length);
    }

    public static void divideAndModulo(final int[] quotient, final int quotient_s, final int quotient_length, final int[] remainder, final int remainder_s, final int remainder_length, final int[] dividend, final int dividend_s, final int dividend_length, final int[] divisor, final int divisor_s, final int divisor_length) {
        final int new_divisor_s = getPrecedingZeros(divisor, divisor_s, divisor_length);
        final int new_divisor_length = divisor_length - new_divisor_s + divisor_s;
        if (0 == new_divisor_length) {
            throw new ArithmeticException("divide by 0");
    ...
    private static int decimalRemainderToTight(final byte[] tight_remainder) {
    ...
    public static void convertDecimalToTight(final int[] integer, final byte[] digits) {
        convertDecimalToTight(integer, 0, integer.length, digits, 0, digits.length);
    }

    public static void convertDecimalToTight(final int[] integer, final int integer_s, final int integer_length, final byte[] digits, final int digits_s, final int digits_length) {
        ...
        while (getPrecedingZeros(quotient_cache, left_boundary, remaining_length) < quotient_cache.length) {
            ...
            divideAndModulo(temp, left_boundary, remaining_length, remainder_cache, 0, remainder_cache.length, quotient_cache, left_boundary, remaining_length, tight_base, 0, tight_base.length);
            integer[integer_index] = decimalRemainderToTight(remainder_cache);
            left_boundary = getPrecedingZeros(temp, left_boundary, remaining_length);
            remaining_length = temp.length - left_boundary;
            System.arraycopy(temp, left_boundary, quotient_cache, left_boundary, remaining_length);
            --integer_index;
    ...
    public static void gcd(final byte[] result, final byte[] a, final byte[] b) {
        gcd(result, 0, result.length, a, 0, a.length, b, 0, b.length);
    }
    ...
    public static void gcd(final byte[] result, final int result_s, final int result_length, final byte[] a, final int a_s, final int a_length, final byte[] b, final int b_s, final int b_length) {
        ...
        int larger_left_boundary = getPrecedingZeros(larger, 0, maximum_length);
        int larger_length = maximum_length - larger_left_boundary;
        int smaller_left_boundary = getPrecedingZeros(smaller, 0, maximum_length);
        ...
        while (0 != compare(smaller, smaller_left_boundary, smaller_length, decimal_zero, 0, decimal_zero.length)) {
            ...
            smaller = temp;
            smaller_left_boundary = getPrecedingZeros(smaller, smaller_left_boundary, smaller_length);
