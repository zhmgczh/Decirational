...
* **Exact Decimal Arithmetic**: Absolute precision for all operations in the decimal rational field (addition, subtraction, multiplication, exact division, and integer division/modulo).
